          ...
          {({ open }) => (
            <div>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                ...
                Customers can choose to send a text or voice note. <br /><br />
                ...
                . We respond to all emails within 30 minutes from the time they hit our inbox. <br /><br />
          ...
          {({ open }) => (
            <div>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                ...
                will also receive an SMS to confirm that you have been entered onto the Motor Insurance Database. <br /><br />
