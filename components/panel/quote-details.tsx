      ...
      {policy ? (
        <div className="py-4 flex flex-col items justify-center space-y-8">
          <div className="flex flex-row space-x-4 items-center">
            ...
            <h1 className="w-max whitespace-nowrap text-center font-bold text-lg capitalize">quote details</h1>
            <hr className="w-full text-gray-700 bg-gray-700" />
          </div>

          <div className="flex flex-col space-y-4">
            <div className="flex flex-row space-x-8 items-center">
              <h1 className="w-max whitespace-nowrap text-center font-bold text-md capitalize">about you</h1>
              <hr className="w-full text-gray-700 bg-gray-700" />
            </div>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row space-x-8 items-center">
              <h1 className="w-max whitespace-nowrap text-center font-bold text-md capitalize">about your vehicle</h1>
              <hr className="w-full text-gray-700 bg-gray-700" />
            </div>
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row space-x-8 items-center">
              <h1 className="w-max whitespace-nowrap text-center font-bold text-md capitalize">about your insurance</h1>
              <hr className="w-full text-gray-700 bg-gray-700" />
            </div>
            <div className="grid grid-cols-4 gap-4">
              <FormGroup
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row space-x-8 items-center">
              <h1 className="w-max whitespace-nowrap text-center font-bold text-md capitalize">Information</h1>
              <hr className="w-full text-gray-700 bg-gray-700" />
            </div>
            <div className="grid grid-cols-4 gap-4">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-row space-x-8 items-center">
              <h1 className="w-max whitespace-nowrap text-center font-bold text-md capitalize">renewal notice</h1>
              <hr className="w-full text-gray-700 bg-gray-700" />
            </div>
            <div className="grid grid-cols-4 gap-4">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="flex flex-row items-center justify-start text-left space-x-2 cursor-pointer">
              ...
              <label htmlFor="acceptTerms" className="leading-tight font-normal cursor-pointer">
                By clicking proced you agree that the details provided in this form are all valid.
              </label>
            </div>
          </div>
